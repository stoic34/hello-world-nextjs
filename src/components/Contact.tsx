...
export default function Contact() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Show confirmation message (would be implemented with state in a real app)
    ...
    <section id="contact" className="py-16 bg-white dark:bg-gray-800">
      <div className="container mx-auto px-4">
        ...
        <p className="text-gray-700 dark:text-gray-300 max-w-3xl mx-auto text-center mb-12">
          I'm always interested in connecting with fellow entrepreneurs, business leaders, and potential partners. If you'd like to discuss business opportunities or just want to say hello, feel free to reach out.
        </p>
          ...
          <div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg">
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  ...
                  <a href="mailto:contact@jasongoncalves.com" className="text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400">
                    contact@jasongoncalves.com
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  ...
                  <a href="https://www.linkedin.com/" target="_blank" rel="noopener noreferrer" className="text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400">
                    Jason Goncalves
                  </a>
                </div>
              </div>
            ...
            <div className="mt-8 pt-6 border-t border-gray-200 dark:border-gray-600">
              ...
              <div className="flex space-x-4">
                <a href="https://www.linkedin.com/" target="_blank" rel="noopener noreferrer" className="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full p-3 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                />
              </div>
